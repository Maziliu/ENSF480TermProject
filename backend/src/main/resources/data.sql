...
('The Lord of the Rings: The Fellowship of the Ring', 10680, 'A meek hobbit and his friends set out to destroy the One Ring.', 'Fantasy, Adventure', 8.8),
('Star Wars: A New Hope', 7500, 'Luke Skywalker joins forces to rescue Princess Leia and save the galaxy.', 'Sci-Fi, Adventure', 8.6),
...
('Schindler''s List', 11700, 'A businessman works to save Jewish refugees during the Holocaust.', 'Biography, Drama', 9.0),
...
('The Green Mile', 11400, 'A death row corrections officer forms a bond with a prisoner.', 'Crime, Drama', 8.6),
...
('The Big Lebowski', 7140, 'The Dude becomes embroiled in a case of mistaken identity.', 'Comedy, Crime', 8.1),
...
(1, 1, '2024-11-23 18:30:00', '[[false, false, false, false, false, false, false, false, false, false, false, false], 
